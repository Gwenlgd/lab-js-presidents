...
function getNamesAndParty(presidentsArr) {
  const newObjPres = presidentsArr.map((president) => {
    const nameAndParty = {
      name: president.name,
...
function getDemocraticPresidents(presidentsArr) {
  const presidentsDemocra = presidentsArr.filter((president) => {
    return president.party === "Democratic"
  });
  return presidentsDemocra
}
...
function getAffiliatedPresidents(presidentsArr) {
  const presidentsWithParty = presidentsArr.filter((president) => {
...
function countRepublicanPresidents(presidentsArr) {
  const presidentsRepu = presidentsArr.reduce((acc, president) => {
